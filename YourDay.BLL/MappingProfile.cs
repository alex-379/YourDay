    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<TaskDto, CompanyStatisticOutputModel>()
                ...
                .ForMember(outputModel => outputModel.IdOrder, taskDto => taskDto.MapFrom(task => task.Order.Id))
                .ForMember(outputModel => outputModel.TitleOrder, taskDto => taskDto.MapFrom(task => task.Order.OrderName))
